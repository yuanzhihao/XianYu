...
//广告的宽度
#define AdViewWidth  _adScrollView.bounds.size.width
//广告的高度
#define AdViewHeight  _adScrollView.bounds.size.height
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        //将内容视图的原点设置在容器左侧，使中间图像视图被显示
        _adScrollView.contentOffset = CGPointMake(AdViewWidth, 0);
        _adScrollView.contentSize = CGSizeMake(AdViewWidth * 3, AdViewHeight);
...
- (void)setAdTitleArray:(NSArray *)adTitleArray withShowStyle:(AdTitleShowStyle)adTitleStyle
{
    ...
    //上面的灰色遮罩
    UIView *vv = [[UIView alloc] initWithFrame:CGRectMake(0, AdViewHeight - 30, AdViewWidth, 30)];
    ...
    _centerAdLabel.frame = CGRectMake(0, AdViewHeight - 30, AdViewWidth-20, 30);
...
- (void)setPageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle
{
    ...
    {
        _pageControl.frame = CGRectMake(0, AdViewHeight - 20, 20*_pageControl.numberOfPages, 20);
    ...
    else if (PageControlShowStyle == UIPageControlShowStyleCenter)
    {
        ...
        _pageControl.center = CGPointMake(AdViewWidth/2.0, AdViewHeight - 20);
    }
    else
    {
        _pageControl.frame = CGRectMake( AdViewWidth - 20*_pageControl.numberOfPages, AdViewHeight - 40, 20*_pageControl.numberOfPages, 20);
    }
...
{
    [_adScrollView setContentOffset:CGPointMake(AdViewWidth * 2, 0) animated:YES];
    _isTimeUp = YES;
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    else if(_adScrollView.contentOffset.x == AdViewWidth * 2)
    {
        centerImageIndex = centerImageIndex + 1;
        leftImageIndex = leftImageIndex + 1;
        rightImageIndex = rightImageIndex + 1;
